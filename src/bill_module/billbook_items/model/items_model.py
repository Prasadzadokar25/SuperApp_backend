...
class BillbookItem:
    def __init__(
        ...
        item_sale_price: Optional[float] = None,
        item_purchase_price: Optional[float] = None,
        item_gst: Optional[float] = None,
    ...
    def from_json(cls, json_data):
        ...
        return cls(
            ...
            item_name=data.get("item_name"),
            item_unit=data.get("item_unit",""),
            item_sale_price=data.get("item_sale_price"),
            item_purchase_price=data.get("item_purchase_price"),
            item_gst=data.get("item_gst"),
            item_shn_no=data.get("item_shn_no"),
            item_stock=data.get("item_stock"),
            item_image=data.get("item_image"),
            item_description=data.get("item_description"),
            item_low_stock_alert=data.get("item_low_stock_alert", False),
            item_low_stock_quantity=data.get("item_low_stock_quantity"),
